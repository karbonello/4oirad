$(document).ready(function(){
    ...
    var position = 0;
    var scrollingLine = document.getElementsByClassName('scrolling-line');

    function func() {
        switch (position) {
            case 0:
                scrollingLine[0].style.marginLeft = '-100%';
                position = 1;
                break;
            case 1:
                scrollingLine[0].style.marginLeft = '-200%';
                position = 2;
                break;
            case 2:
                scrollingLine[0].style.marginLeft = '0';
                position = 0;
                break;
            default:
                break
